...
function FilterChip({
  ...
  return (
    <button
      ...
      aria-pressed={active}
      className={cn(
        "rounded-full border px-[5px] py-[2px] text-mono text-[4px] uppercase tracking-[0.08em] transition-colors",
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <span className="block text-mono text-[6px] uppercase tracking-[0.1em] text-white/40">
          Category
        </span>
