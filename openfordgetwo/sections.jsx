...
function Hero({ accent, headline, showTicker }) {
  ...
  return (
    <section id="top" style={{ padding: "160px 0 120px", minHeight: "100vh", display: "flex", alignItems: "center" }} ref={ref}>
      ...
      <div className="wrap hero-wrap">
        ...
        <div className="hero-foot reveal">
          <p className="hero-sub">
            ...
            <br />mobile apps and AI automation for founders who
            <br />refuse to ship generic.
          </p>
        ...
        {showTicker !== false && <div className="hero-ticker mono">
...
const SERVICES = [
  {
    ...
    icon: (
      <svg viewBox="0 0 40 40" width="40" height="40" fill="none">
        <rect x="3" y="6" width="34" height="24" stroke="currentColor" strokeWidth="1.5"/>
        <line x1="3" y1="12" x2="37" y2="12" stroke="currentColor" strokeWidth="1.5"/>
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 40 40" width="40" height="40" fill="none">
        ...
        <line x1="17" y1="31" x2="23" y2="31" stroke="currentColor" strokeWidth="1.5"/>
        <line x1="11" y1="9" x2="29" y2="9" stroke="currentColor" strokeWidth="1.5"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 40 40" width="40" height="40" fill="none">
        ...
        <circle cx="6" cy="10" r="2.4" stroke="currentColor" strokeWidth="1.5"/>
        <circle cx="6" cy="30" r="2.4" stroke="currentColor" strokeWidth="1.5"/>
        <circle cx="34" cy="20" r="2.4" stroke="currentColor" strokeWidth="1.5"/>
        <line x1="8.2" y1="11.4" x2="16.5" y2="17.5" stroke="currentColor" strokeWidth="1.5"/>
        <line x1="8.2" y1="28.6" x2="16.5" y2="22.5" stroke="currentColor" strokeWidth="1.5"/>
        <line x1="24" y1="20" x2="31.6" y2="20" stroke="currentColor" strokeWidth="1.5"/>
      </svg>
    ),
  },
];
      ...
      <div className="wrap">
        <div className="section-head reveal">
          <div>
            ...
            <div className="num mono" style={{ marginTop: 12 }}>Three lanes. Zero fluff.</div>
          </div>
          <h2>What we forge,<br/>end to end.</h2>
        </div>

        <div className="services-grid">
          {SERVICES.map((s, i) => (
            <article className="service reveal" style={{ transitionDelay: `${i * 80}ms` }} key={s.num}>
              ...
              <ul className="service-tags">
                {s.tags.map((t) => <li key={t} className="mono">{t}</li>)}
              </ul>
...
function WhyUs() {
  return (
    <section id="why" className="whyus">
      <div className="wrap">
        <span className="eyebrow reveal">03 — Why Openforge</span>
        <p className="whyus-line display reveal">
          Most studios ship <span className="whyus-dim">what you asked for</span>.
          <br />
      ...
      <div className="wrap">
        <div className="section-head reveal">
          <div>
            ...
            <div className="num mono" style={{ marginTop: 12 }}>A small, deliberate portfolio.</div>
          </div>
          <h2>Nothing here<br/>is a template.</h2>
        </div>
      </div>

      <div className="work-grid">
        {WORK.map((w, i) => (
          <a key={w.num} href="#" className={"work-item reveal " + (i % 3 === 0 ? "work-wide" : "")}>
            <div className="work-frame" style={{ aspectRatio: w.ratio.replace("/", "/") }}>
              <img src={w.image} alt={w.client + " — " + w.kind} className="work-img" loading="lazy"/>
      ...
      <div className="wrap">
        <div className="section-head reveal">
          <div>
            ...
            <div className="num mono" style={{ marginTop: 12 }}>Things we ship on our own time.</div>
          </div>
          <h2>Built for us,<br/>shared with you.</h2>
        </div>

        <div className="products-grid">
          {PRODUCTS.map((p, i) => (
            <article key={p.num} className={"product reveal" + (p.featured ? " product-featured" : "")} style={{ transitionDelay: `${i * 60}ms` }}>
...
// ──────────────────────────────────────────────────────────────────────
const STEPS = [
  { n: "01", name: "Think",  line: "Week one is strategy, not Figma. We pressure‑test the idea before we touch pixels." },
  { n: "02", name: "Forge",  line: "Design and engineering run in the same sprint. One team, one source of truth." },
  { n: "03", name: "Launch", line: "We ship, measure, iterate. You get the keys and a team that sticks around." },
];
    ...
    <section id="process" className="process">
      <div className="process-marquee" aria-hidden="true">
        <div className="process-marquee-track display">
          <span>THINK</span><span className="dot">◆</span>
          <span>FORGE</span><span className="dot">◆</span>
          <span>LAUNCH</span><span className="dot">◆</span>
          <span>THINK</span><span className="dot">◆</span>
          <span>FORGE</span><span className="dot">◆</span>
          <span>LAUNCH</span><span className="dot">◆</span>
          <span>THINK</span><span className="dot">◆</span>
      ...
      <div className="wrap">
        <div className="section-head reveal">
          <div>
            ...
            <div className="num mono" style={{ marginTop: 12 }}>Three steps. No theatre.</div>
          </div>
          <h2>Think. Forge.<br/>Launch.</h2>
        </div>
      ...
      <div className="wrap">
        <div className="section-head reveal">
          <div>
            ...
            <div className="num mono" style={{ marginTop: 12 }}>Four lines. That's enough.</div>
          </div>
          <h2>A studio of<br/>four, on purpose.</h2>
        </div>

        <ol className="about-lines">
          <li className="reveal"><span className="mono about-num">01</span><p className="display">We're a four‑person studio. On purpose.</p></li>
          <li className="reveal"><span className="mono about-num">02</span><p className="display">Every project has a partner on it. Every day.</p></li>
          <li className="reveal"><span className="mono about-num">03</span><p className="display">We take two clients at a time. Never three.</p></li>
          <li className="reveal"><span className="mono about-num">04</span><p className="display">If we say yes, we already know how it ends.</p></li>
        </ol>
      </div>
    </section>
  );
    ...
    <section id="contact" className="contact">
      <div className="wrap">
        ...
        <div className="contact-ctas reveal">
          <a className="btn btn-green" href="https://wa.me/000000000" target="_blank" rel="noreferrer">
            <WhatsappGlyph />
            WhatsApp
            <span className="arrow">↗</span>
          </a>
          <a className="btn btn-blue" href="https://instagram.com/openforge" target="_blank" rel="noreferrer">
            <InstagramGlyph />
            Instagram DM
            <span className="arrow">↗</span>
          </a>
...
Object.assign(window, { Nav, Hero, Services, WhyUs, Work, Products, Process, About, Contact, Footer });
